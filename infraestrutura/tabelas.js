...
class Tabelas {
    ...
    criarPet() {
        const sql = 'CREATE TABLE IF NOT EXISTS Pets (id int NOT NULL AUTO_INCREMENT, pet varchar(50) NOT NULL,  data datetime NOT NULL, dataCriacao datetime NOT NULL, PRIMARY KEY(id))'
